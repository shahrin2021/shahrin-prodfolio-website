            ...
            <Container>
                <Row>
                    <Col lg={6} md={6} sm={12} style={{display:"flex", justifyContent:"center",alignItems:'center', }}>
                        <div className='bannar-about-text'>
                            ...
                            <p>I am a self-motivated and hard-working person. enjoy creating modern web applications. I Always ready to learn and adopt new technologies.
                            </p>
